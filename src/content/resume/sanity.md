...
Extended `sanity init` to automatically install agent skills and configure Sanity's MCP integration based on the user's local development environment, including detection of supported IDEs and AI agents.
